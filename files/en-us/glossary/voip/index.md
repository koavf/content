...
VoIP (Voice over Internet Protocol) is a technology used to transmit voice messages over IP (Internet Protocol) networks. Common VoIP packages have included Skype, MSN Messenger, Yahoo and many more (some of these have been discontinued, but you may commonly see them mentioned on older websites). Everything transferred through VoIP is digital. It is also known as IP telephony, or broadband telephony. The main reason for using VoIP technology is because of cost.
